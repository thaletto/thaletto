export const metadata = {
    ...
    description: `A reference implementation of the AG-UI protocol and A2UI specification a chat interface whose purpose is not merely to respond, but to make the ordinarily invisible machinery of agent communication legible.`,
};
