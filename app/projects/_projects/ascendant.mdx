export const metadata = {
    ...
    description: `A Python library for Vedic astrology calculations, publishing to PyPI the ancient machinery of Jyotish: divisional charts, dasha timelines, and yoga combinations, all computable from a birth moment and a coordinate.`,
};
