export const metadata = {
  ...
  startDate: "2023.09",
  endDate: "2024.05",
  description: `Lung cancer kills with particular efficiency partly because it so often goes unnoticed until it has made itself unmissable. This project assembles three deep learning architectures, V-Net, YOLOv5s, and DETR, into a single detection pipeline that finds the nodules a radiologist might miss and declines to invent the ones that are not there.`,
};
...
<br />
<LinkChip icon="pdf" link="/lung-nodule-detection.pdf" label="View PDF" />
