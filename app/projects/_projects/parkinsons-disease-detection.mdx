export const metadata = {
  ...
  description: `Parkinson's disease leaves a signature in the voice long before it announces itself in more obvious ways. This project asks whether that signature, extracted as biomedical acoustic features from a voice recording, is legible to a machine learning classifier, and then asks the question of nine different classifiers simultaneously to find out which one reads it best.`,
};
