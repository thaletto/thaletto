export const metadata = {
  ...
  company: "TCS",
  description: `An autonomous multi-agent system that detects, diagnoses, and resolves production incidents end-to-end, with a human kept firmly in the loop and a vector-indexed brain consulted at every step.`,
};
