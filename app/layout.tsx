                ...
                <TooltipProvider>
                    ...
                    <div className="flex flex-col mobile:flex-row">
                        ...
                        <main className="relative flex-1 max-w-208 contain-[inline-size]">
                            <div className="absolute w-full h-px opacity-50 bg-border right-0 mobile:right-auto mobile:left-0 mobile:w-px mobile:h-full mobile:opacity-100 mix-blend-multiply" />
