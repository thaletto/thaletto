            ...
            >
                ...
                <div className="flex flex-col mobile:flex-row">
                    ...
                    <main className="relative flex-1 max-w-2xl contain-[inline-size]">
                        <div className="hidden mobile:block absolute w-full h-px opacity-50 bg-rurikon-border right-0 mobile:right-auto mobile:left-0 mobile:w-px mobile:h-full mobile:opacity-100 mix-blend-multiply" />
                        <ViewTransition name="crossfade">
                            <article className="pl-0 mobile:pl-6 sm:pl-10 md:pl-14 pt-2 md:pt-0">
                                {children}
                            </article>
                        </ViewTransition>
                    </main>
