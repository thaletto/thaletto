// Proximity-hover engine: reports the nearest item (and its rect) to the
// pointer over the dock. Powers the active-indicator slide, the merge/split
// selected-background, and the dock tooltips from a single pointer model.
'use client'
