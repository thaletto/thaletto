// Merge/split of the dock's selected background: the active highlight clips
// between the previously active item and the newly hovered one, driven by the
// same proximity model as the indicator dot. Rendered with AnimatePresence so
// the sheet animates out independently of the list re-render.
'use client'
