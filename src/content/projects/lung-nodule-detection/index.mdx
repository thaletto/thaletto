...
![Sample detections by YOLOv5s](./yolo-prediction.png#693x696 "Sample detections by YOLOv5s")
...
<TechStack variant="embedded">
  ...
  <TechStackItem label="TensorFlow"><TensorflowIconDark className="tech-stack-icon-needs-invert" /></TechStackItem>
</TechStack>
