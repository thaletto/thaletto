...
<TechStack variant="embedded">
  ...
  <TechStackItem label="React 19">
    <ReactLight />
  </TechStackItem>
  <TechStackItem label="TypeScript">
    <Typescript />
  </TechStackItem>
  <TechStackItem label="Tailwind CSS">
    <Tailwindcss />
  </TechStackItem>
  <TechStackItem label="Go">
    <Golang className="tech-stack-icon-needs-invert" />
  </TechStackItem>
  <TechStackItem label="SQLite">
    <Sqlite />
  </TechStackItem>
  <TechStackItem label="AWS Lambda">
    <AwsLight className="tech-stack-icon-needs-invert" />
  </TechStackItem>
  <TechStackItem label="Cloudflare">
    <Cloudflare />
  </TechStackItem>
</TechStack>
