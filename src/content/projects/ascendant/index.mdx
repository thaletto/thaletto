---
title: "Ascendant"
description: "Agent skills and tools for AI coding agents that perform reliable, local Vedic astrology: saved birth records, charts, dashas, yogas, Ashtakavarga, and transits, with auditable readings."
...
- **Agent Platform:** Skills pack with bundled scripts, installed via the Skills CLI or the Codex plugin marketplace
- **Language:** Python
- **Distribution:** PyPI (`astro-ascendant`)
- **Documentation:** [Getting Started](https://ascendant-docs.vercel.app/docs) · [Agent Workflows](https://ascendant-docs.vercel.app/docs/agents) · [Skill Specifications](https://ascendant-docs.vercel.app/docs/skills/career) · [Ashtakavarga](https://ascendant-docs.vercel.app/docs/library/ashtakavarga)