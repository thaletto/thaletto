---
title: 'Kite'
description: 'Ask questions, get AI generated UI'
...
<TechStack variant="embedded">
  ...
  <TechStackItem label="shadcn/ui">
    <ShadcnUi className="tech-stack-icon-needs-invert" />
  </TechStackItem>
  <TechStackItem label="Tailwind CSS 4">
    <Tailwindcss />
  </TechStackItem>
  <TechStackItem label="Upstash Redis">
    <Upstash />
  </TechStackItem>
  <TechStackItem label="Netlify">
    <Netlify />
  </TechStackItem>
