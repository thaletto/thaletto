// Shape context: tracks the current "visible surface shape" (one of the
// site's blueprint/shader panels) so sibling visual treatments — shaders,
// overlays, motion controllers — subscribe to the active one instead of being
// wired to route internals. Purely presentational; no data flows through it.
'use client'
