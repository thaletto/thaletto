export const metadata = {
  ...
  image: "/content/projects/lung-nodule-detection/lungnodule.webp",
  imageWidth: 1536,
  imageHeight: 1024,
  startDate: "2023.09",
  endDate: "2024.05",
...
![Sample detections by YOLOv5s](./yolo-prediction.png#693x696:crisp "Sample detections by YOLOv5s")
