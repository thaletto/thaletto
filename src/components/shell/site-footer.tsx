...
export function SiteFooter({
  ...
  return (
    <footer className="mx-auto mt-24 w-full max-w-168 px-6 pb-24 text-sm text-muted-foreground sm:pb-12">
      <div className="hairline-top grid grid-cols-2 gap-x-6 gap-y-8 pt-8 sm:grid-cols-3">
        <Tree label="contact">
          ...
          <li>
            <EmailCard identity={siteIdentity} />
          </li>
        </Tree>
        <Tree label="index">
          <li>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="footer-geo" aria-hidden>
              ...
              <span className="footer-geo-lines">
                <span>{siteIdentity.location.latitude}</span>
                <span>{siteIdentity.location.longitude}</span>
              </span>
            </div>
          </div>
        </div>
