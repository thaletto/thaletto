...
import { siteDestinations, siteIdentity, siteSocial } from '~/lib/content/personal'
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="m5.5,2.25.671,2.579,2.579.671-2.579.671-.671,2.579-.671-2.579-2.579-.671,2.579-.671.671-2.579Z"
          fill="currentColor"
        />
...
function HomeContact({ social, github }: { social: SocialSnapshot; github: GitHubActivity }) {
  return (
    <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      />
      , or on <GitHubCard data={github} trigger="GitHub" triggerClassName="home-contact-link" />, email
      me at{' '}
      <EmailCard
