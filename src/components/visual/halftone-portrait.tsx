...
export function HalftonePortrait({
  ...
  useEffect(() => {
    ...
    // Captured by nested closure below; TS drops flow narrowing inside nested
    // functions, so bind the guarded, non-null value once at this point.
    ...
    function draw() {
      ...
      for (const cell of field.cells) {
        ...
        context.fillStyle = `rgb(${cell.red} ${cell.green} ${cell.blue})`
        context.beginPath()
