...
import { useShape } from '~/lib/design/shape-context'
...
const RadioGroup = forwardRef<HTMLDivElement, RadioGroupProps>(
  ({ children, selectedIndex, value, onValueChange, className, ...props }, ref) => {
    ...
    const resolvedSelectedIndex =
      value !== undefined ? childValues.indexOf(value) : (selectedIndex ?? -1)
    ...
    const content = (
      <div
        ...
        onKeyDown={(e) => {
          ...
          const preventBaseUI = (e as unknown as { preventBaseUIHandler?: () => void })
  ...
  ({ label, index, selected, onSelect, value, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        {value !== undefined && (
          <RadioPrimitive.Root value={value} className="sr-only" tabIndex={-1} aria-hidden />
        )}
      </div>
    )
  },
