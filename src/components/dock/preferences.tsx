...
import { PreferencesIcon } from '~/components/dock/dock-icons'
import { useTheme } from '~/components/shell/theme-provider'

import { TabItem, Tabs, TabsList } from '~/components/ui/tabs'
import { Elevated } from '~/lib/design/elevated'
import { playPreferenceSound, setSoundEnabled, soundEnabled } from '~/lib/platform/sound'
...
export function Preferences() {
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        render={
          <button type="button" className="dock-item" aria-label="Preferences" disabled={!mounted}>
            <PreferencesIcon />
