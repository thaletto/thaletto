...
export function FooterClock() {
  ...
  return (
    <div className="footer-local-time">
      <svg className="footer-local-clock" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
      ...
      <span className="footer-time-readout">
        ...
        <time
          ...
          aria-label={
            now
              ? `Current time in Chennai, UTC+5:30: ${label}`
              : 'Current time in Chennai, UTC+5:30'
          }
        >
          {label}
        </time>
